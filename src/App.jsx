        ...
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-16 md:grid-cols-2 md:px-6 md:py-24">
          <div>
            ...
            <h1 className="font-heading mt-4 text-4xl font-bold leading-[1.1] text-ink md:text-5xl">
              Прецизна статика. Оптимизиран материјал. Изведба без дефекти.
            </h1>
            <p className="mt-6 max-w-lg text-base leading-relaxed text-ink/70">
              Проектираме сеизмички отпорни бетонски и челични конструкции. Преку строга примена
              на Еврокодовите и напредна 3D структурна анализа, испорачуваме BIM модели без
              колизии кои ја максимизираат просторната ефикасност и драстично ги намалуваат
              трошоците за материјал за архитектите и изведувачите.
            </p>
